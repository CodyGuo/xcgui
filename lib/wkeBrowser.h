...
XC_API void WINAPI XWeb_Init();
XC_API void WINAPI XWeb_UnInit();
XC_API unsigned int WINAPI XWeb_GetVersion();
XC_API const utf8* WINAPI XWeb_GetVersionString();
XC_API void* WINAPI XWeb_Create(int x,int y,int cx,int cy,HXCGUI hParent);	
XC_API int WINAPI XWeb_OnImeStartComposition(void* hWeb,WPARAM wParam,LPARAM lParam,BOOL *pbHandled);
...
XC_API void WINAPI XWeb_RenderBtimap(void* hWeb,HDRAW  hDraw);
...
XC_API void WINAPI XWeb_OnDocumentReady(void* hWeb,void* callback,void* param = NULL);
XC_API void WINAPI XWeb_OnLoadingFinish(void* hWeb,void* callback,void* param = NULL);
XC_API void WINAPI XWeb_OnCreateView(void* hWeb,void* callback,void* param=NULL);
...
XC_API void* WINAPI XWeb_GetWebView(void* hWeb);
